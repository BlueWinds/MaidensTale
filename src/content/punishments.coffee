...
Data.events.PunishMachineYes =
  text: ->"""
    ...
    #{if g.clothes isnt 'naked' then "With brisk efficiency the man removes your clothing, cutting away your top so he doesn't have to free your hands, then shoves you onto the seat." else "With a stinging slap on your already nude behind, the woman goads you to lay down."} Two pairs of hands, one rough and one gentle, strap your ankles in securely, then pass belts across your hips, stomach, chest, and around your forehead. Finally they free your hands - but only for a moment, enough time to strap down your wrists as well.
